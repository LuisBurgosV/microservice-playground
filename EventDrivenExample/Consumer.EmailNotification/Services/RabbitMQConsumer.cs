...
namespace Consumer.EmailNotification.Services;
...
public class RabbitMQConsumer : BackgroundService
{
    ...
    private const string QueueName = "email-notification-queue";
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        // Suscribirse a eventos de usuarios y pedidos
        _channel.QueueBind(QueueName, ExchangeName, "events.usercreatedevent");
        _channel.QueueBind(QueueName, ExchangeName, "events.ordercreatedevent");
        ...
        _channel.BasicConsume(
            queue: QueueName,
            autoAck: false,
            consumerTag: "email-notification-consumer",
            consumer: consumer
        );

        _logger.LogInformation("📨 Consumer de Email Notification iniciado");
